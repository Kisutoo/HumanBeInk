 ...
 */
final class Version20251021091808 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tattoo ADD user_id INT NOT NULL, ADD final_price NUMERIC(10, 2) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tattoo DROP user_id, DROP final_price');
    }
}
