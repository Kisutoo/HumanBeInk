...
final class Version20250926075343 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS area (id INT AUTO_INCREMENT NOT NULL, name_area VARCHAR(50) NOT NULL, sensibility SMALLINT DEFAULT NULL, multiplicator NUMERIC(10, 2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS color (id INT AUTO_INCREMENT NOT NULL, type_color VARCHAR(50) NOT NULL, multiplicator NUMERIC(10, 2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS detail (id INT AUTO_INCREMENT NOT NULL, detail_name VARCHAR(50) NOT NULL, multiplicator NUMERIC(10, 2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS flash (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, image VARCHAR(255) NOT NULL, taille DOUBLE PRECISION NOT NULL, couleur VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, INDEX IDX_AFCE5F0312469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS size (id INT AUTO_INCREMENT NOT NULL, size NUMERIC(10, 2) NOT NULL, multiplicator NUMERIC(10, 2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS tattoo (id INT AUTO_INCREMENT NOT NULL, size_id INT NOT NULL, color_id INT NOT NULL, area_id INT NOT NULL, detail_id INT NOT NULL, base_price NUMERIC(10, 2) NOT NULL, name VARCHAR(100) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, final_price NUMERIC(10, 2) NOT NULL, INDEX IDX_DEE4C6F498DA827 (size_id), INDEX IDX_DEE4C6F7ADA1FB5 (color_id), INDEX IDX_DEE4C6FBD0F409C (area_id), INDEX IDX_DEE4C6FD8D003BB (detail_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, pseudonyme VARCHAR(50) NOT NULL, google_id VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS user_flash (user_id INT NOT NULL, flash_id INT NOT NULL, INDEX IDX_4D0CA45BA76ED395 (user_id), INDEX IDX_4D0CA45B25F8D5EA (flash_id), PRIMARY KEY(user_id, flash_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
